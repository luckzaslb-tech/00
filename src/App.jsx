    ...
    <div style={{
      ...
      {spark.length>1&&<div style={{height:52,margin:"16px 0 14px",position:"relative"}}>
        {(()=>{
          ...
          const posColor="rgba(46,204,142,.6)",negColor="rgba(248,113,113,.6)";
          const lineColor=sal>=0?posColor:negColor;
          return(
            <svg viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="none" style={{width:"100%",height:"100%"}}>
              ...
              {vals.map((v,i)=>{
                ...
                return isLast?<circle key={i} cx={cx} cy={cy} r={4} fill={lineColor} opacity={.9}/>:null;
              })}
            </svg>
          );
        })()}
